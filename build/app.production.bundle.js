...
var Title_Title = function Title(props) {
  return react_default.a.createElement("div", null, react_default.a.createElement("h1", null, props.title), react_default.a.createElement("p", null, "Number of tasks: ", props.numberOfTasks));
};
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = {
      ...
      data: [],
      title: 'Webpack loaders' //jak podać liczbę zadań
  ...
  _createClass(App, [{
    ...
    value: function addTodo(val) {
      //metoda dodająca nowe elementy do kolekcji
      var todo = {
        text: val,
        id: uuid_default.a.v4() //tworzenie unikatowej kombinację cyfr i liczb
    ...
    value: function removeTodo(id) {
      //matoda obługująca usuwanie rzeczy do zrobienia
    ...
    value: function render() {
      //metoda wyświetlajaca całą aplikację
      return react_default.a.createElement("div", {
        className: App_default.a.TodoApp
      }, "Tutaj pojawi\u0105 si\u0119 komponenty naszej aplikacji.")
      /*tutaj musze dodać chyba title i numberOfTasks*/
      ;
    }
  }]);
